                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card card-primary">
                                ...
                                ?>
                                    <form action="proseseditbooking.php" method="POST">
                                        <div class="card-body">
                                            <div class="form-group">
                                                <input name="id_booking" type="hidden" class="form-control" value="<?php echo $row['id_booking']; ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Nama Mobil</label>
                                                <input name="nama_mobil" type="text" class="form-control" value="<?php echo $row['nama_mobil']; ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputPassword1">Jenis Perawatan</label>
                                                <input name="jenis_perawatan" type="text" class="form-control" value="<?php echo $row['jenis_perawatan']; ?>">
                                            </div>
                                            <div class="form-group">
